...
('Sabun Lifebuoy Total 10', 'Kebersihan', 4500, 200, 'Sabun mandi keluarga antimam bakteri.'),
('Rinso Anti Noda 800g', 'Kebersihan', 21000, 40, 'Deterjen bubuk hilangkan noda.'),
('Pepsodent Pencegah Gigi Berlubang 190g', 'Kesehatan', 12000, 100, 'Pasta gigi perlindungan maksimal.');
...
('Endang S', 'endang@test.com', '081112341234', 'Jl. Veteran No. 9, Bali');
