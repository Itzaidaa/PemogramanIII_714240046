...
type Mahasiswa struct {
	NPM    string         `json:"npm"    gorm:"column:npm;primaryKey;type:varchar(20);not null" example:"2300012345"`
	...
	NoHP   string         `json:"no_hp,omitempty"  gorm:"column:no_hp;type:varchar(20)" example:"08123456789"`
